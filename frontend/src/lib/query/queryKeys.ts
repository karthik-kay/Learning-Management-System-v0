export const queryKeys = {
  public: {
    ...
    faculty: (params?: unknown) =>
      ["public", "faculty", params ?? {}] as const,
    ...
    reviews: (params?: unknown) =>
      ["public", "reviews", params ?? {}] as const,
    reviewSummary: () => ["public", "reviews", "summary"] as const,
    certifications: (params?: unknown) =>
      ["public", "certifications", params ?? {}] as const,
    certification: (slug: string) =>
      ["public", "certifications", slug] as const,
    successStories: (params?: unknown) =>
      ["public", "content", "success-stories", params ?? {}] as const,
    successStory: (slug: string) =>
      ["public", "content", "success-stories", slug] as const,
    successStorySummary: () =>
      ["public", "content", "success-stories", "summary"] as const,
    successStoryFilters: () =>
      ["public", "content", "success-stories", "filters"] as const,
    search: (params: unknown) =>
      ["public", "content", "search", params] as const,
  },
  student: {
