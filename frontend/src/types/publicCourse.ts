...
export interface PublicFacultyAchievement {
  title?: string;
  description?: string;
  year?: string;
}
...
export interface PublicFacultyListItem {
  id: number;
  display_name: string;
  slug: string;
  headline: string;
...
export interface PublicFacultyProfile extends PublicFacultyListItem {
  bio: string;
  experience: PublicFacultyExperience[];
  achievements: PublicFacultyAchievement[];
  linkedin_url: string;
  github_url: string;
  website_url: string;
  booking_url: string;
...
export interface PublicFacultyListParams {
  search?: string;
  expertise?: string;
  availability?: "available" | "waitlist" | "unavailable";
  featured?: boolean;
...
export interface PublicCourseProductListItem {
  ...
  instructors: PublicFacultyListItem[];
  domain: string | null;
  level: PublicLevel;
