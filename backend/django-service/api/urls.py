...
urlpatterns = [
    ...
    path("public/reviews/", include("reviews.public_urls")),
    path("public/certifications/", include("certifications.public_urls")),
    path("public/support/", include("tickets.public_urls")),
    path("public/conversion/", include("sales.public_urls")),
