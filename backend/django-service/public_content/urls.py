...
from public_content.views import (
    ...
    SuccessStoryFiltersAPIView,
    SuccessStoryListAPIView,
    SuccessStorySummaryAPIView,
    UniversalSearchAPIView,
)
...
urlpatterns = [
    ...
    path("success-stories/", SuccessStoryListAPIView.as_view(), name="public-success-story-list"),
    path("success-stories/summary/", SuccessStorySummaryAPIView.as_view(), name="public-success-story-summary"),
    path("success-stories/filters/", SuccessStoryFiltersAPIView.as_view(), name="public-success-story-filters"),
    path("success-stories/<slug:slug>/", SuccessStoryDetailAPIView.as_view(), name="public-success-story-detail"),
    ...
    path("search/", UniversalSearchAPIView.as_view(), name="public-universal-search"),
]
